...
namespace BloodBankManagement
{
    public class Operations
    {
        ...
        static List<Donation> DonationList=new List<Donation>();  //Donation List Creation

         static List<UserRegistration> UserRegistrationsList=new List<UserRegistration>();  //User Donation List Creation
