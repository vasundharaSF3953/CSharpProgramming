...
namespace ECommerceApplication
{
    ...
    public class Operations
    {
        ...
        static List<CustomerDetails> CustomerDetailsList=new List<CustomerDetails>(); //Customer list creation

        static List<ProductDetails> ProductDetailsList=new List<ProductDetails>();  //Product List creation.

        static List<OrderDetails> OrderDetailsList=new List<OrderDetails>();  //Order List Creation.
                ...
                if(count<=product1.Stock)
                {
                    ...
                    foreach(CustomerDetails customer1 in CustomerDetailsList)
                    {
                        ...
                        if(order1.ProductId==product1.ProductId)
                        {
                             ...
                             Console.WriteLine("Your order will be delivery on"+date1);
